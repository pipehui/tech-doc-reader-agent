...
relation_assistant_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "\n2. 使用 read_learning_history 查看用户已经学过哪些相关知识。"
            "\n3. 使用 search_related_docs 检索候选类比知识点。"
            "\n4. 必要时再使用 read_docs 补充理解目标知识点或候选知识点。"

            "\n\n你的工作顺序应尽量遵循："
            "\n1. 先明确当前要帮助理解的目标知识点。"
            "\n2. 优先识别用户已学知识中是否存在可作为类比桥梁的内容。"
            "\n3. 再从知识库中补充候选知识点。"
            "\n4. 从中筛选最有教学价值的 1 到 3 个类比对象。"
            "\n5. 输出结构化类比分析结果。"
