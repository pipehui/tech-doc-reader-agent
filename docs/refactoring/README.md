...
| 2026-07-12 | Documentation：长期文档、API payload 与当前模块所有权对齐 | 完成，SSE 文档 event/field 漂移门禁已接入 | [2026-07-12-maintained-documentation-alignment.md](2026-07-12-maintained-documentation-alignment.md) |
